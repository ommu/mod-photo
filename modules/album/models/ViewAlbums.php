 ...
 * @created date 26 August 2016, 11:17 WIB
...
class ViewAlbums extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('photos, photo_publish, photo_unpublish', 'length', 'max'=>21),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('album_id, photos, photo_publish, photo_unpublish', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('t.photo_publish',strtolower($this->photo_publish),true);
		$criteria->compare('t.photo_unpublish',strtolower($this->photo_unpublish),true);
