 ...
 * Photos
 *
 * Photos represents the model behind the search form about `app\modules\album\models\Photos`.
 *
...
use app\modules\album\models\Photos as PhotosModel;
...
class Photos extends PhotosModel
{
	...
	public function rules()
	{
		return [
			...
			[['photo', 'title', 'caption', 'creation_date', 'modified_date', 'updated_date', 'albumTitle', 'memberDisplayname', 'userDisplayname', 'creationDisplayname', 'modifiedDisplayname'], 'safe'],
		];
	}
